...
$getInfo = "SELECT position, memberName, gradeYear, major, minor, omtechFav, omtechEvent, uwecFav, funFact FROM members WHERE position = 'Secretary'";
...
<body>
  ...
  <div class="header">
    ...
    <div class="contentContainer">
        ...
        <img class="photo" src="images/hannah_headshot.jpg" alt = "OmTech Secretary">
            <img class="memberPhoto" src="images/omtech_scavenger_hunt_6.jpg" alt = "Hannah at a meeting">
        </div>
        <div class="card">
            <div class="container">
