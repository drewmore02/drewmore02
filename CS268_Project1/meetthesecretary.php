...
$getInfo = "SELECT * FROM members WHERE position = 'Secretary'";
...
<div class="contentContainer">
    ...
    <img class="photo" src="<?php echo $profileSrc ?>" alt = "OmTech Secretary">
        <img class="memberPhoto" src="<?php echo $memberSrc ?>" alt = "Secretary at a meeting">
    </div>
    <div class="card">
        <div class="container">
