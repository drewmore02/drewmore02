...
$getInfo = "SELECT position, memberName, gradeYear, major, minor, omtechFav, omtechEvent, uwecFav, funFact FROM members WHERE position = 'Treasurer'";
...
<body>
  ...
  <div class="header">
    ...
    <div class="contentContainer">
        ...
        <img class="photo" src="images/laura_headshot.jpg" alt = "OmTech Treasurer">
